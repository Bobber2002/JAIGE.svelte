...
<div
  class="relative h-full flex flex-col bg-gray-600 transition-[width_.5s] {Open
    ? 'w-44'
...
>
  ...
  <button
    on:click={Toggle}
    class="hover:w-6 hover:-right-6 transition-[all] absolute top-0
    -right-4 bg-inherit shadow-[inset_15px_0_17px_-7px_rgba(0,0,0,.25)] h-12
    w-4 rounded-br-lg text-sm text-black text-opacity-40 font-black grid place-items-center"
  >
